...
Viewer.prototype = {
  ...
  init_after_loading_content : function() {
    ...
    this.navigate_to_dest(decodeURIComponent(document.location.hash.substring(1)))
  ...
  navigate_to_dest : function(detail_str, src_page) {
    console.log("navigate (" + detail_str + ", " + src_page + ")")
    try {
      var detail = JSON.parse(detail_str);
      console.log(detail)
    } catch(e) {
      var el = document.getElementById(detail_str);
